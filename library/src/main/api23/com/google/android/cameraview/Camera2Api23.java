...
class Camera2Api23 extends Camera2 {
    ...
    Camera2Api23(Callback callback, PreviewImpl preview, Context context, DrawCirclePreview drawCirclePreview) {
        super(callback, preview, context, drawCirclePreview);
    }
